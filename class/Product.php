...
class Product extends Database
{
	...
	public function updateProduct_noimg($id,$id_kategori,$nama_produk,$keterangan){
		$stmt = $this->query("UPDATE ".$this->tableName." SET id_kategori = '$id_kategori', nama_produk = '$nama_produk', keterangan = '$keterangan' WHERE id_produk = '$id'");
		return $stmt;
	}
